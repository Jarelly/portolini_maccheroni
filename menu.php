			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Menú especial</h2>
						<p>Aquí encontrarás nuestros distintos platillos, postres y bebidas </p>
					</div>
				</div>
			</div>
						...
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 special-grid drinks">
									...
									{
									?>
											<a href="addcart.php?pid=<?php echo $r['id']; ?>&uid=<?php echo $_SESSION['uid']; ?>&price=<?php echo $r['price']; ?>">Añadir-Carrito</a></h5>
									...
									{
									?>
										<a href="login.php">Añadir-Carrito</a>
									<?php } ?>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						...
						<p>"Nuestra prioridad eres tú, nos interesa conocer tus opiniones"</p>
					</div>
				</div>
			</div>
			<div class="row">
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner mt-4">
							...
							$s = mysqli_query($con,"select * from review  limit 4");	
	                         ...
	                         <div class="carousel-item text-center ">
								...
								<h6 class="text-dark m-0">Opinión : <?php echo $r['review']; ?></h6>
								<p class="m-0 pt-3">
						...
						<?php } ?>
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Mariana</strong></h5>
								<h6 class="text-dark m-0">Opinión : Bueno</h6>
								<p class="m-0 pt-3">
									Bueno, bueno, saludable
