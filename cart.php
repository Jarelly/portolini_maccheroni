...
<center> <p style="font-size: 2.4em; color: red"> Puedes ver tus productos seleccionados aquí 	</p> </center> 
	<div style="width: 90%; padding: 20px; text-align: right;">
			<a href="checkout.php"><img src="images/chcekout.png" width="40"></a>
			<a href="checkout.php">Verificar</a> 
		</div>
	<br>
	<div>
...
INNER JOIN menu ON addcart.p_id=menu.id where addcart.u_id='$uid'");
		?>
		<table border=8 width="80%" align="center" cellpadding="6" cellspacing="10" style="color: green">
		<tr><th>Vista  </th>
			<th>Precio</th>
			<th>Cantidad</th>
			<th>Total</th>
		...
		<?php
		 ...
		 ?>
			<tr>
				...
				<td><a href="deletecart.php?id=<?php echo $r['id']; ?>">Eliminar</a></td>
